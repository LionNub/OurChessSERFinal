...
public class PixelSpriteRenderer {
    ...
    private static final Color WHITE_HILITE  = new Color(0xFFFFFF); // white
    private static final Color BLACK_BODY    = new Color(0x101018); // near-black
    private static final Color BLACK_HILITE  = new Color(0xF5F5DC); // cream
